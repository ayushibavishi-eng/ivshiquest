...
export const MOCK_BIRDS_ON_WIRES: DiscoveryContent = {
  ...
  retrieval: {
    ...
    incorrectFeedback:
      "Not quite. Think about what happens when electricity has a difference in electrical potential to travel across.",
...
export const MOCK_DISCOVERIES: DiscoveryContent[] = [MOCK_BIRDS_ON_WIRES];
